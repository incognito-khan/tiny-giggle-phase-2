  ...
  const AppointmentCard = ({ app }) => (
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-2 md:border-l md:border-slate-50 md:pl-6 shrink-0">
         {app.status === "COMPLETED" && (app.reportUrl || app.checkupReport) && (
           <Button 
            ...
            >
             ...
             View {app.checkupReport ? "Checkup" : "Report"}
           </Button>
         )}
         {app.status === "ACCEPTED" && (
           <Button 
        ...
        <DialogContent className="sm:max-w-[500px] bg-white rounded-3xl p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-500 font-medium">
              Report from {viewingReport?.doctor ? `Dr. ${viewingReport.doctor.name}` : viewingReport?.babysitter?.name}
            </DialogDescription>
          </DialogHeader>
          
          <div className="py-6 min-h-[200px] bg-slate-50/50 rounded-2xl p-4 border border-slate-100">
            {viewingReport?.checkupReport ? (
              <p className="text-slate-700 leading-relaxed font-medium whitespace-pre-wrap">
                ...
                <div className="flex flex-col items-center justify-center py-8">
                    ...
                    <p className="text-slate-600 font-bold mb-4">A file report is available</p>
                    <Button 
                        asChild
                ...
                <p className="text-slate-400 italic text-center py-10">No report content available.</p>
            )}
          </div>
