...
import BabysitterProfileSettings from "@/components/dashboard/babysitter-profile-settings";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs.jsx";

export default function BabysitterSettingsPage() {
  return (
    <div className="space-y-8 pb-10 max-w-6xl mx-auto">
      ...
      >
        ...
        <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-none">
          Settings & <span className="text-purple-600">Preferences</span>
        </h1>
        <p className="text-slate-500 font-semibold">Customize your gig experience and how you get paid.</p>
      </motion.div>
