...
export default function Community() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      setDeleting(true);
      const { data } = await DELETE(`/community/questions/${questionToDelete}`);
      if (data.success) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F8FAFC]">
      ...
      <DeleteConfirmModal
        ...
        description="Are you sure you want to remove this question? This will also permanently delete all associated answers."
      />
    </div>
  );
}
