...
export default function Blogs() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url(https://html.vecurosoft.com/toddly/demo/assets/img/class/class-bg.png)",
      }}
    >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-500 font-semibold text-base leading-relaxed">
                  {facility.excerpt.slice(0, 90)}.
                </p>

                {/* Arrow Button */}
                <div className="pt-2 flex justify-between items-center">
                  <Link href={`/blogs/${facility.id}`}>
                    <div className="flex gap-2 items-center">
                      <p className="text-gray-800 font-semibold hover:text-brand transition-all duration-300">
                        Read More
                      </p>
